/******************************
  Program "gen_sym_skeleton.m" compiled by "Caching Murphi Release 5.4.9"
...
#define PROTOCOL_NAME "gen_sym_skeleton"
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n1.value((r % 3) + 6);
    r = r / 3;
    return tsprintf("Process response, n1:%s", mu_n1.Name());
  }
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n1.value((r % 3) + 6);
    r = r / 3;
    return tsprintf("Process fwd_response, n1:%s", mu_n1.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_NodeIDs mu_n1;
    ...
    r = r / 3;
bool mu__boolexpr10;
  if (!((mu_Nodes[mu_n1].mu_IncomingQueue[mu_Nodes[mu_n1].mu_FrontPointer].mu_msg_type) == (mu_fwd_response))) mu__boolexpr10 = FALSE ;
  else {
  mu__boolexpr10 = ((mu_Nodes[mu_Nodes[mu_n1].mu_Next].mu_TailPointer) < (mu_BufferSpace)) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr11;
  if (!((mu_Nodes[mu_n1].mu_IncomingQueue[mu_Nodes[mu_n1].mu_FrontPointer].mu_msg_type) == (mu_fwd_response))) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = ((mu_Nodes[mu_Nodes[mu_n1].mu_Next].mu_TailPointer) < (mu_BufferSpace)) ; 
}
	      if (mu__boolexpr11) {
		if ( ( TRUE  ) )
		  return;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n1.value((r % 3) + 6);
    r = r / 3;
    return tsprintf("Process fwd_request, n1:%s", mu_n1.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_NodeIDs mu_n1;
    ...
    r = r / 3;
bool mu__boolexpr12;
  if (!((mu_Nodes[mu_n1].mu_IncomingQueue[mu_Nodes[mu_n1].mu_FrontPointer].mu_msg_type) == (mu_fwd_request))) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = ((mu_Nodes[mu_Nodes[mu_n1].mu_Next].mu_TailPointer) < (mu_BufferSpace)) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr13;
  if (!((mu_Nodes[mu_n1].mu_IncomingQueue[mu_Nodes[mu_n1].mu_FrontPointer].mu_msg_type) == (mu_fwd_request))) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = ((mu_Nodes[mu_Nodes[mu_n1].mu_Next].mu_TailPointer) < (mu_BufferSpace)) ; 
}
	      if (mu__boolexpr13) {
		if ( ( TRUE  ) )
		  return;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n1.value((r % 3) + 6);
    r = r / 3;
    return tsprintf("Process request, n1:%s", mu_n1.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_NodeIDs mu_n1;
    ...
    r = r / 3;
bool mu__boolexpr14;
  if (!((mu_Nodes[mu_n1].mu_IncomingQueue[mu_Nodes[mu_n1].mu_FrontPointer].mu_msg_type) == (mu_request))) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = ((mu_Nodes[mu_Nodes[mu_n1].mu_Next].mu_TailPointer) < (mu_BufferSpace)) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr15;
  if (!((mu_Nodes[mu_n1].mu_IncomingQueue[mu_Nodes[mu_n1].mu_FrontPointer].mu_msg_type) == (mu_request))) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = ((mu_Nodes[mu_Nodes[mu_n1].mu_Next].mu_TailPointer) < (mu_BufferSpace)) ; 
}
	      if (mu__boolexpr15) {
		if ( ( TRUE  ) )
		  return;
...
public:
  ...
  char * Name(unsigned r)
  {
    static mu__subrange_17 mu_n2_hops;
    mu_n2_hops.value((r % 2) + 1);
    r = r / 2;
    static mu_1_NodeIDs mu_n1;
    mu_n1.value((r % 3) + 6);
    r = r / 3;
    return tsprintf("Send Request, n2_hops:%s, n1:%s", mu_n2_hops.Name(), mu_n1.Name());
  }
  bool Condition(unsigned r)
  {
    static mu__subrange_17 mu_n2_hops;
  ...
  void Code(unsigned r)
  {
    ...
    mu_n1.value((r % 3) + 6);
    r = r / 3;
mu_SendRequest ( mu_n1, (int)mu_n2_hops );
  };
...
bool Condition(unsigned r)
{
  ...
  if (r>=12 && r<=17) return R4.Condition(r-12);
...
void Code(unsigned r)
{
  ...
  if (r>=12 && r<=17) { R4.Code(r-12); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=12 && r<=17) { return R4.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=12 && r<=17) return R4.Name(r-12);
  return NULL;
}
};

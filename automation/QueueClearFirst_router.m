...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
            rule "Rule --> Send request"
                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (TailPointers[n1][EntryPath[n1]] = 0) & (Routers[n1] = 0) & (Routers[n2] = 0)
            ==>
            Begin
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Send request + Send request"
                        (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (TailPointers[n1][EntryPath[n1]] = 0) & (Routers[n1] = 0) & (Routers[n2] = 0) & 
                        (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (TailPointers[n3][EntryPath[n3]] = 0) & (Routers[n3] = 0) & (Routers[n4] = 0) & 
                        (n1 != n3)
                    ==>
                    Begin
                        SendRequest(n1, ExitPath[n1], n2);
                ...
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Send request"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (TailPointers[n1][EntryPath[n1]] = 0) & (Routers[n1] = 0) & (Routers[n2] = 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (TailPointers[n3][EntryPath[n3]] = 0) & (Routers[n3] = 0) & (Routers[n4] = 0) & 
                                (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (TailPointers[n5][EntryPath[n5]] = 0) & (Routers[n5] = 0) & (Routers[n6] = 0) & 
                                (n1 != n3) & 
                                (n1 != n5) & 
                                (n3 != n5)
                            ==>
                        ...
                        ruleset n7: 0..NumberNodes-1 do
                            ruleset n8: 0..NumberNodes-1 do
                                    rule "Rule --> Send request + Send request + Send request + Send request"
                                        ...
                                        (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (TailPointers[n3][EntryPath[n3]] = 0) & (Routers[n3] = 0) & (Routers[n4] = 0) & 
                                        (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (TailPointers[n5][EntryPath[n5]] = 0) & (Routers[n5] = 0) & (Routers[n6] = 0) & 
                                        (n7 != n8) & (TailPointers[ExitPath[n7]][n7] < BufferSpace) & (TailPointers[n7][EntryPath[n7]] = 0) & (Routers[n7] = 0) & (Routers[n8] = 0) & 
                                        (n1 != n3) & 
                                        (n1 != n5) & 
                                        (n1 != n7) & 
                                        (n3 != n5) & 

...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
            rule "Rule --> Send request"
                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (IntentToSendRequest[n1] != 2)
            ==>
            Begin
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
                rule "Rule --> Process request + Send request"
                    (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                    (n3 != n3) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n3] = 0) & (IntentToSendRequest[n3] != 2) & 
                    (n1 != n2)
                ==>
                Begin
                    ProcessRequest(n1, EntryPath[n1], ExitPath[n1]);
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Send request + Send request"
                        (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (IntentToSendRequest[n1] != 2) & 
                        (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (IntentToSendRequest[n3] != 2) & 
                        (n1 != n3)
                    ==>
                    Begin
                        if ((IntentToSendRequest[n1] = 1) | (TailPointers[n1][EntryPath[n1]] = 0)) then
            ...
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_response + Send request + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (n3 != n3) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n3] = 0) & (IntentToSendRequest[n3] != 2) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
                            (n1 != n2) & 
                            (n1 != n4) & 
                            (n2 != n4)
                        ==>
                        Begin
                            ...
                            if ((IntentToSendRequest[n4] = 1) | (TailPointers[n4][EntryPath[n4]] = 0)) then
                            SendRequest(n4, ExitPath[n4], n5);
                            IntentToSendRequest[n4] := 0;
                        else
                            IntentToSendRequest[n4] := 2;
                        endif;
                        endrule;
                endruleset;
            endruleset;
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_response + Process fwd_response + Process fwd_response + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_response + Process request + Process request + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_response + Process fwd_response + Process request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (IntentToSendRequest[n4] != 1) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_request + Process request + Process request + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_response + Process request + Process response + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
                ...
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                        ruleset n7: 0..NumberNodes-1 do
                                rule "Rule --> Process fwd_response + Send request + Send request + Send request"
                                    (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                                    (n3 != n3) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n3] = 0) & (IntentToSendRequest[n3] != 2) & 
                                    (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_request + Process response + Process response + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_response + Process request + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & (IntentToSendRequest[n3] != 1) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & (IntentToSendRequest[n4] != 1) & 
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                        ruleset n7: 0..NumberNodes-1 do
                                rule "Rule --> Process fwd_request + Send request + Send request + Send request"
                                    (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                                    (n3 != n3) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n3] = 0) & (IntentToSendRequest[n3] != 2) & 
                                    (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
                                    (n6 != n7) & (TailPointers[ExitPath[n6]][n6] < BufferSpace) & (Routers[n6] = 0) & (Routers[n7] = 0) & (IntentToSendRequest[n6] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_request + Process fwd_response + Process fwd_response + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Process fwd_response + Process response + Send request + Send request"
                                (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                                (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & (IntentToSendRequest[n2] != 1) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (IntentToSendRequest[n3] != 2) & 
                                (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (IntentToSendRequest[n5] != 2) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Process fwd_response + Process request + Send request + Send request"
                                (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                                (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (IntentToSendRequest[n3] != 2) & 
                                (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (IntentToSendRequest[n5] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_response + Process response + Process response + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Process fwd_request + Process response + Send request + Send request"
                                (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                                (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & (IntentToSendRequest[n2] != 1) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (IntentToSendRequest[n3] != 2) & 
                                (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (IntentToSendRequest[n5] != 2) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Process fwd_request + Process request + Send request + Send request"
                                (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                                (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (IntentToSendRequest[n3] != 2) & 
                                (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (IntentToSendRequest[n5] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_request + Process request + Process response + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_response + Process fwd_response + Process fwd_response + Process request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (IntentToSendRequest[n4] != 1) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_response + Process request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (IntentToSendRequest[n4] != 1) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_response + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_response + Process request + Process request + Process request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (IntentToSendRequest[n4] != 1) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_request + Send request"
                            (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                            (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                            (n4 != n5) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & (Routers[n4] = 0) & (Routers[n5] = 0) & (IntentToSendRequest[n4] != 2) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_response + Process request + Process request + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (IntentToSendRequest[n1] != 1) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & (IntentToSendRequest[n2] != 1) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (IntentToSendRequest[n3] != 1) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & (IntentToSendRequest[n4] != 1) & 

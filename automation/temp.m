...
var Tokens: array[NodeIDs] of 0..NumberTokens+1;
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
            rule "Rule --> Send request"
                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0)
            ==>
            Begin
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Send request + Send request"
                        (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                        (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                        (n1 != n3)
                    ==>
                    Begin
                        SendRequest(n1, ExitPath[n1], n2);
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
                rule "Rule --> Send request + Process fwd_request"
                    (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                    (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                    (n1 != n3)
                ==>
                Begin
                    SendRequest(n1, ExitPath[n1], n2);
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
                rule "Rule --> Send request + Process fwd_response"
                    (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                    (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                    (n1 != n3)
                ==>
                Begin
                    SendRequest(n1, ExitPath[n1], n2);
                ...
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Send request"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (Tokens[n5] > 0) & 
                                (n1 != n3) & 
                                (n1 != n5) & 
                                (n3 != n5)
                            ==>
            ...
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Send request + Process request"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                            (n1 != n3) & 
                            (n1 != n5) & 
                            (n3 != n5)
                        ==>
            ...
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Send request + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
                            (n1 != n3) & 
                            (n1 != n5) & 
                            (n3 != n5)
                        ==>
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Send request + Process fwd_request + Process fwd_request"
                        (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                        (n1 != n3) & 
                        (n1 != n4) & 
                        (n3 != n4)
                    ==>
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Send request + Process fwd_request + Process fwd_response"
                        (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                        (n1 != n3) & 
                        (n1 != n4) & 
                        (n3 != n4)
                    ==>
                    ...
                    ruleset n6: 0..NumberNodes-1 do
                        ruleset n7: 0..NumberNodes-1 do
                            ruleset n8: 0..NumberNodes-1 do
                                    rule "Rule --> Send request + Send request + Send request + Send request"
                                        (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                        (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                        (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (Tokens[n5] > 0) & 
                                        (n7 != n8) & (TailPointers[ExitPath[n7]][n7] < BufferSpace) & (Routers[n7] = 0) & (Routers[n8] = 0) & (Tokens[n7] > 0) & 
                                        (n1 != n3) & 
                                        (n1 != n5) & 
                                        (n1 != n7) & 
                                        (n3 != n5) & 
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                        ruleset n7: 0..NumberNodes-1 do
                                rule "Rule --> Send request + Send request + Send request + Process fwd_request"
                                    (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                    (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                    (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (Tokens[n5] > 0) & 
                                    (IncomingQueue[n7][EntryPath[n7]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n7]][n7] < BufferSpace) & 
                                    (n1 != n3) & 
                                    (n1 != n5) & 
                                    (n1 != n7) & 
                                    (n3 != n5) & 
                                ...
                                Tokens[n3] := Tokens[n3] - 1;
                                    SendRequest(n5, ExitPath[n5], n6);
                                Tokens[n5] := Tokens[n5] - 1;
                                    ProcessFwdRequest(n7, EntryPath[n7], ExitPath[n7]);
                                endrule;
                        endruleset;
                    endruleset;
                endruleset;
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                        ruleset n7: 0..NumberNodes-1 do
                                rule "Rule --> Send request + Send request + Send request + Process request"
                                    (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                    (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                    (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (Tokens[n5] > 0) & 
                                    (IncomingQueue[n7][EntryPath[n7]][0].msg_type = request) & (TailPointers[ExitPath[n7]][n7] < BufferSpace) & 
                                    (n1 != n3) & 
                                    (n1 != n5) & 
                                    (n1 != n7) & 
                                    (n3 != n5) & 
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                        ruleset n7: 0..NumberNodes-1 do
                                rule "Rule --> Send request + Send request + Send request + Process fwd_response"
                                    (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                    (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                    (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (Tokens[n5] > 0) & 
                                    (IncomingQueue[n7][EntryPath[n7]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n7]][n7] < BufferSpace) & 
                                    (n1 != n3) & 
                                    (n1 != n5) & 
                                    (n1 != n7) & 
                                    (n3 != n5) & 
                                ...
                                Tokens[n3] := Tokens[n3] - 1;
                                    SendRequest(n5, ExitPath[n5], n6);
                                Tokens[n5] := Tokens[n5] - 1;
                                    ProcessFwdResponse(n7, EntryPath[n7], ExitPath[n7]);
                                endrule;
                        endruleset;
                    endruleset;
                endruleset;
        ...
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                        ruleset n7: 0..NumberNodes-1 do
                                rule "Rule --> Send request + Send request + Send request + Process response"
                                    (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                    (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                    (n5 != n6) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & (Routers[n5] = 0) & (Routers[n6] = 0) & (Tokens[n5] > 0) & 
                                    (IncomingQueue[n7][EntryPath[n7]][0].msg_type = response) & 
                                    (n1 != n3) & 
                                    (n1 != n5) & 
                                    (n1 != n7) & 
                                    (n3 != n5) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process fwd_request + Process fwd_request"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process fwd_request + Process request"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = request) & (TailPointers[ExitPath[n6]][n6] < BufferSpace) & 
                                (n1 != n3) & 
                                (n1 != n5) & 
                                (n1 != n6) & 
                                (n3 != n5) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process fwd_request + Process fwd_response"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process fwd_request + Process response"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = response) & 
                                (n1 != n3) & 
                                (n1 != n5) & 
                                (n1 != n6) & 
                                (n3 != n5) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process request + Process request"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = request) & (TailPointers[ExitPath[n6]][n6] < BufferSpace) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process request + Process fwd_response"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n6]][n6] < BufferSpace) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process request + Process response"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = response) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process fwd_response + Process fwd_response"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n6]][n6] < BufferSpace) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process fwd_response + Process response"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = response) & 
    ...
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                    ruleset n6: 0..NumberNodes-1 do
                            rule "Rule --> Send request + Send request + Process response + Process response"
                                (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                                (n3 != n4) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & (Routers[n3] = 0) & (Routers[n4] = 0) & (Tokens[n3] > 0) & 
                                (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
                                (IncomingQueue[n6][EntryPath[n6]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process fwd_request + Process fwd_request"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process fwd_request + Process request"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process fwd_request + Process fwd_response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process fwd_request + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process request + Process request"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process request + Process fwd_response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process request + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process fwd_response + Process fwd_response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process fwd_response + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_request + Process response + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process request + Process request + Process request"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = request) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process request + Process request + Process fwd_response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process request + Process request + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process request + Process fwd_response + Process fwd_response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process request + Process fwd_response + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process request + Process response + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_response + Process fwd_response + Process fwd_response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n5]][n5] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_response + Process fwd_response + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process fwd_response + Process response + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                ruleset n5: 0..NumberNodes-1 do
                        rule "Rule --> Send request + Process response + Process response + Process response"
                            (n1 != n2) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & (Routers[n1] = 0) & (Routers[n2] = 0) & (Tokens[n1] > 0) & 
                            (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                            (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
                            (IncomingQueue[n5][EntryPath[n5]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_request + Process fwd_request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_request + Process request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_request + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_request + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process request + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_response + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_request + Process fwd_response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process request + Process request + Process request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process request + Process request + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process request + Process request + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process request + Process fwd_response + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process request + Process fwd_response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process request + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_response + Process fwd_response + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process fwd_response + Process fwd_response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_request + Process response + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process request + Process request + Process request"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = request) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process request + Process request + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process request + Process request + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = request) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process request + Process fwd_response + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process request + Process fwd_response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process request + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = request) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process fwd_response + Process fwd_response + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process fwd_response + Process fwd_response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process fwd_response + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process request + Process response + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = request) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_response + Process fwd_response + Process fwd_response + Process fwd_response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n4]][n4] < BufferSpace) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_response + Process fwd_response + Process fwd_response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n2]][n2] < BufferSpace) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n3]][n3] < BufferSpace) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process fwd_response + Process response + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = fwd_response) & (TailPointers[ExitPath[n1]][n1] < BufferSpace) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
...
ruleset n1: 0..NumberNodes-1 do
    ruleset n2: 0..NumberNodes-1 do
        ruleset n3: 0..NumberNodes-1 do
            ruleset n4: 0..NumberNodes-1 do
                    rule "Rule --> Process response + Process response + Process response + Process response"
                        (IncomingQueue[n1][EntryPath[n1]][0].msg_type = response) & 
                        (IncomingQueue[n2][EntryPath[n2]][0].msg_type = response) & 
                        (IncomingQueue[n3][EntryPath[n3]][0].msg_type = response) & 
                        (IncomingQueue[n4][EntryPath[n4]][0].msg_type = response) & 
